...
def get_argparse():
    ...
    parser.add_argument("--data_dir", default="data/dataset", type=str, help="The input data dir")
    ...
    parser.add_argument("--tensorboard_dir", default='data/tb', type=str, help="the dir for tensorboard events")
    ...
    parser.add_argument("--model_type", default="Bert_Token", type=str,
                        help="SICM, BertFeatureLSTMCRF, BertBiLSTMCRF....")
    parser.add_argument("--config_name", default="data/bert/config.json", type=str, help="the config of define model")
    parser.add_argument("--vocab_file", default="data/bert/vocab.txt", type=str, help="the vocab file for bert")
    parser.add_argument("--word_vocab_file", default="data/tencent_embedding/tencent_vocab.txt", type=str)
    parser.add_argument("--label_file", default="data/dataset/label.txt", type=str)
    parser.add_argument("--default_label", default='O', type=str)
    parser.add_argument("--word_embedding", default="data/tencent_embedding/word_embedding.txt",
                        help="the embedding file path")
    parser.add_argument("--saved_embedding_dir", default="data/tencent_embedding", type=str)
    ...
    parser.add_argument("--add_phonetic", default=True, type=bool)
    parser.add_argument("--add_glyph", default=True, type=bool)
    parser.add_argument("--add_feature_gate", default=False, type=bool)
    parser.add_argument("--add_final_attention", default=True, type=bool)
    parser.add_argument("--add_final_gate", default=False, type=bool)
    parser.add_argument("--add_middle_attention", default=False, type=bool)
