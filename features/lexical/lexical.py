...
from features.lexical.trie import Trie
        ...
        if len(words) == 0:
            ...
            for word in words:
                ...
                if word_length == 1:
                    ...
                    sent_words[idx][0].append(word) 
                    sent_group_mask[idx][0] = 1
                    for pos in range(1, word_length-1):
                        sent_words[idx+pos][1].append(word) 
                    sent_words[idx+word_length-1][2].append(word) 
